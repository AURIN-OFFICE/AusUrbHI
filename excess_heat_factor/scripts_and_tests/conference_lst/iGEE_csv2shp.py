...
# Load the shapefile
shape_data = gpd.read_file('../../boundary_data/sa1_nsw.shp')

# Ensure the SA1_CODE21 is int in both dataframes
csv_data['SA1_CODE21'] = csv_data['SA1_CODE21'].astype(str)
shape_data['SA1_MAIN16'] = shape_data['SA1_MAIN16'].astype(str)

# Merge the dataframes based on the SA1 codes
merged = shape_data.merge(csv_data, how='left', left_on='SA1_MAIN16', right_on='SA1_CODE21')
