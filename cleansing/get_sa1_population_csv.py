...
abs_2016_g01_gdf = gpd.read_file("../_data/AusUrbHI HVI data processed/ABS 2016/"
...
abs_2021_g01_gdf = gpd.read_file("../_data/AusUrbHI HVI data processed/ABS 2021/main_G01_SA1_2021_NSW_study_area_refined.shp")
